...
#if (ENABLE_UVC_CAMERA_FUNCTION)
#if (ENABLE_UVC_WIFI_XFER)
// 覆盖配置项，设置STA模式，禁用AP模式
#undef EXAMPLE_ESP_WIFI_AP_SSID
#define EXAMPLE_ESP_WIFI_AP_SSID ""  // 禁用AP模式
#define EXAMPLE_ESP_WIFI_SSID "GL-SFT1200-15b"  // 这里填写您的WiFi名称
#define EXAMPLE_ESP_WIFI_PASS "sicausicau"  // 这里填写您的WiFi密码
app_wifi_main();
app_httpd_main();
#endif //ENABLE_UVC_WIFI_XFER
